...
function PrivacyPolicy({clubInfo}) {
  ...
  return (
    <Container>
      ...
      <p>En {data.clubName}, trataremos tus datos personales recabados a través del Sitio Web: {clubInfoDomain.tuintraDomain}, con las siguientes finalidades:</p>
      <ol>
        ...
        <li>Envío de información solicitada a través de los formularios dispuestos en {clubInfoDomain.tuintraDomain}</li>
      ...
      <p>Derechos propiedad intelectual {data.clubName} es titular de todos los derechos de autor, propiedad intelectual, industrial, "know how" y cuantos otros derechos guardan relación con los contenidos del sitio web {clubInfoDomain.tuintraDomain} y los servicios ofertados en el mismo, así como de los programas necesarios para su implementación y la información relacionada.</p>
      <p>No se permite la reproducción, publicación y/o uso no estrictamente privado de los contenidos, totales o parciales, del sitio web {clubInfoDomain.tuintraDomain} sin el consentimiento previo y por escrito.</p>
